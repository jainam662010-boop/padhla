...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 bottom-0 z-50 flex flex-col border-r border-sidebar-border transition-[width] duration-200 ease-out',
          'lg:relative',
          'lg:backdrop-blur-xl',
          ...
          <div className="border-t border-sidebar-border">
            <div className={cn('px-2 py-2', !sidebarOpen && 'flex justify-center')}>
              {sidebarOpen ? (
                ...
                <button onClick={() => setSidebarOpen(true)} className="relative" aria-label="Expand sidebar">
          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'flex flex-col items-center gap-0.5 py-2 flex-1 min-w-0 transition-colors',
